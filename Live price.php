...
<body>
    ...
    <div class="header_top" id="home">
      <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
        ...
        <a class="navbar-brand" href="index.php">
          <img src="images\mgj.png" height="100px" style="none" alt="icon"></a>
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item active">
              <a class="nav-link cool" href="Live price.php">Live Price</a>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="Gold.php">Gold</a>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Live price</li>
  </ol>
  <!-- js -->
  ...
  <iframe src="https://www.goldpriceindia.com/wmshare-wlifop-002.php" style=" position:fixed; left:0px;  right:0px; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;"></iframe>
