...
<body>
		...
		<div class="header_top" id="home">
			<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
						<ul class="navbar-nav">
								<li class="nav-item">
								  <a class="nav-link cool" href="index.php">Home </a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item dropdown">
								  <a class="nav-link dropdown-toggle cool" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Jewellery <i class="fas fa-angle-down"></i>
								  </a>
			...
			<div class="col-md-4 contact_grids_info">
				<div class="contact_grid">
					<div class="contact_grid_right">
						...
						<p>84-85, 8th St,</p>
						<p>Cross Cut Rd, Opp. Lakshmi Complex,</p>
	...
	<footer>
		...
		<div class="instagram-posts">
				<h3 class="tittle cen foot">Instagram Posts</h3>
